  ...
  if(iccRankingName === 'man'){
    if(iccRankingType === 'team'){
        if(iccRankingTap === 'odi'){
            ...
            canonical = `https://uccricket.live/iccranking/man/team/odi`;
        }else if(iccRankingTap === 'test'){
            ...
            canonical = `https://uccricket.live/iccranking/man/team/test`;
        }else if(iccRankingTap === 't20'){
            ...
            canonical = `https://uccricket.live/iccranking/man/team/t20`;
        }
        ...
        if(iccRankingTap === 'odi'){
            ...
            canonical = `https://uccricket.live/iccranking/man/batter/odi`;
        }else if(iccRankingTap === 'test'){
            ...
            canonical = `https://uccricket.live/iccranking/man/batter/test`;
        }else if(iccRankingTap === 't20'){
            ...
            canonical = `https://uccricket.live/iccranking/man/batter/t20`;
        }
        ...
        if(iccRankingTap === 'odi'){
            ...
            canonical = `https://uccricket.live/iccranking/man/bowler/odi`;
        }else if(iccRankingTap === 'test'){
            ...
            canonical = `https://uccricket.live/iccranking/man/bowler/test`;
        }else if(iccRankingTap === 't20'){
            ...
            canonical = `https://uccricket.live/iccranking/man/bowler/t20`;
        }
        ...
        if(iccRankingTap === 'odi'){
            ...
            canonical = `https://uccricket.live/iccranking/man/all-rounder/odi`;
        }else if(iccRankingTap === 'test'){
            ...
            canonical = `https://uccricket.live/iccranking/man/all-rounder/test`;
        }else if(iccRankingTap === 't20'){
            ...
            canonical = `https://uccricket.live/iccranking/man/all-rounder/t20`;
        }
    }
    ...
    if(iccRankingType === 'team'){
        if(iccRankingTap === 'odi'){
            ...
            canonical = `https://uccricket.live/iccranking/woman/team/odi`;
        }else if(iccRankingTap === 't20'){
            ...
            canonical = `https://uccricket.live/iccranking/woman/team/t20`;
        }
    }else if(iccRankingType === 'batter'){
        if(iccRankingTap === 'odi'){
            ...
            canonical = `https://uccricket.live/iccranking/woman/batter/odi`;
        }else if(iccRankingTap === 't20'){
            ...
            canonical = `https://uccricket.live/iccranking/woman/batter/t20`;
        }
    }else if(iccRankingType === 'bowler'){
        if(iccRankingTap === 'odi'){
            ...
            canonical = `https://uccricket.live/iccranking/woman/bowler/odi`;
        }else if(iccRankingTap === 't20'){
            ...
            canonical = `https://uccricket.live/iccranking/woman/bowler/t20`;
        }
    }else if(iccRankingType === 'all-rounder'){
        if(iccRankingTap === 'odi'){
            ...
            canonical = `https://uccricket.live/iccranking/woman/all-rounder/odi`;
        }else if(iccRankingTap === 't20'){
            ...
            canonical = `https://uccricket.live/iccranking/woman/all-rounder/t20`;
        }
    }
  }
  return {
