      ...
      <section className="lg:w-[1000px] mx-auto md:mb-0 my-4 px-2 lg:px-0">
        <div className="md:grid grid-cols-12 gap-4">
          <div className="lg:col-span-8 md:col-span-7">
            <div className="lg:col-span-8 md:col-span-7">
              <TeamInfo teamDetails={teamDetails} teamType={teamType} coach={coach} teamCaptains={teamCaptains}></TeamInfo>
                ...
                <div id="test" className="">
                  ...
                  <div className="rounded-lg bg-[#ffffff] p-4 mb-4">
                    <div className="md:flex justify-between items-center pb-2">
                      ...
                      <div className="flex space-x-4 md:mt-0 mt-2">
                    ...
                    <div className="cust-tp-pera-card-section">
                      ...
                      <div className="mt-5">
                        {activeSquad === "Batter" && <div className="grid md:grid-cols-12 grid-cols-6 gap-4">
                    ...
                    <div className="lg:hidden rounded-lg p-4 mb-4 bg-[#ffffff] performance-section relative hover:shadow-lg">
                        ...
                        <div className="open-Performance-data">
                          <div className="py-2 pb-3">
                            ...
                            <div className="flex justify-between items-center text-[14px]">
                              ...
                              <div className="w-[80%] font-semibold text-center flex space-x-1 justify-end">
                                {isSameDay(
                                  new Date(),
                                  new Date(ucmatch.date_start_ist)
                                ) ? (
                      ...
                      <div className="flex items-center justify-between space-x-5 mt-2">
                        <div className="flex items-center">
                          ...
                          >
                            <p className="text-colorThird text-[11px] font-medium">
                              Points Table
                            </p>
                          </Link>
                          <div className="h-[20px] border-l-[1px] mx-5 border-[#d0d3d7]"></div>
                        ...
                        <div className="flex items-center space-x-2 text-[11px]">
                          <span className="text-colorThird font-medium">BAN</span>
                            ...
                            {matchData?.map(
                              (items: {
                                ...
                                items.winning_team_id == teama_id ? (
                                  <span
                                    key={items.match_id}
                                    className="bg-[#13B76D] text-white text-[13px] px-[6px] py-[3px] rounded w-[24px] text-center inline-block"
                                  >
                                    W
                                  </span>
                                ) : (
                                  <span
                                    key={items.match_id}
                                    className="bg-[#F63636] text-white text-[13px] px-[7px] py-[3px] rounded w-[24px] text-center inline-block"
                                  >
                                    L
                                  </span>
                                )
