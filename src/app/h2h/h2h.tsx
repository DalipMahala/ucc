...
export default function H2h({featuredMatch,teamDetails,teamADetails,teamBDetails,urlStrings, completedMatch}:H2h) {
                                      ...
                                      <div className="md:col-span-6 col-span-12 cust-tp-pera-card" key={index}>
                                          <div className="bg-[#f2f7ff] rounded-lg max-w-md w-full p-4 border-[1px]">
                                              <div className="flex justify-between items-center pb-1">
                                                      ...
                                                      <h2 className="text-1xl font-semibold">{match?.subtitle}</h2>
                                                      <p className="text-[#7B4C09] font-medium">
                                                      {match?.date_start_ist && format(new Date(match?.date_start_ist), "dd MMMM yyyy")} {/* - {format(new Date(match.date_start_ist), "hh:mm:aa")} */}
                                                      </p>
